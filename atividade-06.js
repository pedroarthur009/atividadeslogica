...
// let ficarbebado = idade >= 18 && podebeber
//     console.log(`Pode beber? ${ficarbebado}`);
...
// console.log(`manutençao = ${modoManutencao}`);
// console.log(`lugavaga = ${lugarVago}`);
// console.log(`lugar0cupado = ${lugarOcupado}`);
...
//console.log("");
// let peso = LerTeclado.question('Seu Peso:')
// let altura = LerTeclado.question('Sua Altura:')
...
//console.log(`Se ${imc} <= ${imcAbaixoDoPeso}`)
//console.log(`Ola! diga seu peso ${peso}, e sua altura ${altura}`);
//console.log(`${imc}`);
// ------------------------------------------------------------
...
console.log(`NTF : ${notaFinal}`);
console.log(`precisa de rec : ${precisaRecuperacao}`)
console.log(`reprov : ${reprovado}`)
console.log(`precisahelp : ${precisaDeAjuda}`)
