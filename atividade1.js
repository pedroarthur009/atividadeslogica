...
// console.log ( ` meu nome é ${meuNome} porque nao usar var? ${naoUsarVar} qual sua idade? ${minhaIdade} qual ano nascimento? ${ANO_NASCIMENTO} `);
...
let minhavida = `Ola! meu nome é ${nome}, tenho ${idade} anos, meço ${altura} e moro em ${cidade} e estou estudando javascript: ${estudandoJS}`
