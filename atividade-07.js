...
// let idade = lerTeclado.questionFloat('Qual sua idade?')
...
// → Seu código aqui:
// let temphoje = lerTeclado.questionFloat('Qual a temperatura?')

// if(temphoje < 10){
//     console.log('Muito frio')}

// else if(temphoje >= 10 && temphoje <= 18){
//     console.log('frio')}

// else if(temphoje >= 18 && temphoje  <= 25){
//     console.log('agradavel')}

// else if(temphoje >= 25 && temphoje <= 35){
//     console.log('quente')}
...
// → Seu código aqui:
let name = lerTeclado.question('Qual o seu nome?')
let temingresso = lerTeclado.keyInYN("Voce tem ingresso?")
let suaidade = lerTeclado.questionInt('Qual sua idade ?')
